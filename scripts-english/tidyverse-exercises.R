...
# Exercise 3 ----
# Calculate the average horsepower of cars that can travel more than 20 miles on one gallon of gasoline

# Exercise 4 ----
# Calculate the average fuel consumption per liter/100 km by gearbox type
# 1 mile per gallon is equal to 0.425 km per liter
...
# Exercise 13 ----
# Create a new dataset that contains Americas countries, sorted by population growth (pop) between 1952 and 2007
